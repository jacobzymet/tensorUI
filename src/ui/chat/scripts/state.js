...
const btnManageConvos = document.getElementById('btnManageConvos');
const sidebarBulkActions = document.getElementById('sidebarBulkActions');
const sidebarBulkCount = document.getElementById('sidebarBulkCount');
const btnBulkPinConvos = document.getElementById('btnBulkPinConvos');
const btnBulkDeleteConvos = document.getElementById('btnBulkDeleteConvos');
